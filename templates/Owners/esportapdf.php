...
$html .= '</tr></thead>';
 ...
 $html .= '<tr>';
         $html.='<td>' . h($owner->id).'</td>';
        $html.='<td>' . h($owner->cmu).'</td>';
        $html.='<td>' . h($owner->name).'</td>';
        $html.='<td>' . h($owner->title).'</td>';
...
$html .= '</table>';
	...
	$this->Pdf->core->SetTitle('owners');
	$this->Pdf->core->SetSubject('owners');
	$this->Pdf->core->SetKeywords('owners');
	// set default header data
	$this->Pdf->core->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, 'owners', '');
	...
	$this->Pdf->core->writeHTML($html, true, false, false, false, '');
        ob_end_clean();
	$this->Pdf->core->Output('Export_owners.pdf', 'D');      
