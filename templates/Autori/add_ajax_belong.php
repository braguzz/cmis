  ...
  function Add() {
       ...
       <!--  e inserisce il dato di ritorno nel  -->
        ...
        jQuery.ajax({
            ...
            $('#autore_id').append(newOption).trigger('change');               
...
<div class="modal-dialog" role="document" id="modalautori">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Aggiungi Autore </h5>
...
<div class="autori form content card-body">
     ...
     <?= $this->Form->create($autore,['id'=>'addautori','url' => false]);   
    ...
    <fieldset>
        <?php
           ...
           if (($return['returncontroller'])=='generi')
           {
             $f_id=$return['id'];
             echo $this->Form->hidden('genere_id', array('hiddenField' => true, 'value'=> $f_id));
           }
           else
           {
...
<script>
     $(document).ready(function () {    doAcSelect2('genere_id', 'Generi' , 'title', 3, 'modalAutori');  
    });
</script>
