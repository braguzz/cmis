...
<h1 class="page-header"><?= 'Autori' ?></h1>
 </div>  
...
<table class="table table-sm table-borderless">
   ...
   <td>  
        <?= $this->Form->control('genere_id', ['empty' => 'scegli']) ?>    
   </td>   
...
<li><?= $this->Html->link(__('New Autore'), ['action' => 'add'], ['class' => 'nav-link']) ?></li>
<li><?= $this->Html->link(__('List Generi'), ['controller' => 'Generi', 'action' => 'index'], ['class' => 'nav-link']) ?></li>
<li><?= $this->Html->link(__('New Genere'), ['controller' => 'Generi', 'action' => 'add'], ['class' => 'nav-link']) ?></li>
...
<table class="table table-striped table-sm">
    ...
    <tr>
        ...
        <th scope="col"><?= $this->Paginator->sort('cognome') ?></th>
        <th scope="col"><?= $this->Paginator->sort('note') ?></th>
        <th scope="col"><?= $this->Paginator->sort('genere_id') ?></th>
    ...
    <tbody>
        ...
        <tr>
           ...
           <div class="btn-group" role="group" >
                ...
                <?= $this->Html->link('', ['action' => 'view', $autore->id], ['title' => __('View'), 'class' => 'btn btn-outline-dark btn-sm bi-info-lg mr-1']) ?>

                <?= $this->Html->link('', ['action' => 'edit', $autore->id], ['title' => __('Edit'), 'class' => 'btn btn-outline-dark btn-sm bi-pencil mr-1']) ?>

                <?= $this->Form->postLink('', ['action' => 'delete', $autore->id], ['confirm' => __('Are you sure you want to delete # {0}?', $autore->id), 'title' => __('Delete'), 'class' => 'btn btn-sm btn-danger bi-trash mr-1']) ?>
