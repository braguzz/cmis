...
<table class="table table-striped table-sm">
    ...
    <?= $this->Form->postButton('', ['controller' => $return['returncontroller'], 'action' => 'addhabtm', $return['returncontrollerid']],['data'=>['id'=>$autore->id, 'returnid'=>$return['returncontrollerid'], 'return'=>'Autori'], 'class' => 'btn btn-outline-dark btn-sm bi-check  mr-1','title'=>'Inserisci collegamento']) ?>
