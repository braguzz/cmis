...
use Cake\View\Helper\TimeHelper;
 ...
 foreach ($autori as $autore) : 
        $riga =$this->Number->format($autore->id);
...
$foglioExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(4, $riganum, $riga); 
 $autore->has('genere') ? $riga= $autore->genere->title : $riga.='';
...
endforeach; 
   ...
   $col=6;      
	...
	header('Content-Disposition: attachment;filename="Export_autore.xlsx"');      //nome del file    
