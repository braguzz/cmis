...
$html .= '</tr></thead>';
 ...
 $html .= '<tr>';
        $html.='<td>' . $this->Number->format($devmodel->id).'</td>';
        $html.='<td>' . h($devmodel->title).'</td>';
        $html.='<td>' . h($devmodel->brand).'</td>';
        $html.='<td>' . h($devmodel->tipo).'</td>';
       $html.='<td>' . $this->Number->format($devmodel->costo).'</td>';
...
$html .= '</table>';
	...
	$this->Pdf->core->SetTitle('devmodels');
	$this->Pdf->core->SetSubject('devmodels');
	$this->Pdf->core->SetKeywords('devmodels');
	// set default header data
	$this->Pdf->core->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, 'devmodels', '');
	...
	$this->Pdf->core->writeHTML($html, true, false, false, false, '');
        ob_end_clean();
	$this->Pdf->core->Output('Export_devmodels.pdf', 'D');      
