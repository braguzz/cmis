...
<h1 class="page-header"><?= 'Devmodels' ?></h1>
 </div>  
...
<li><?= $this->Html->link(__('New Devmodel'), ['action' => 'add'], ['class' => 'nav-link']) ?></li>
...
<li><?= $this->Html->link(__('List Devsims'), ['controller' => 'Devsims', 'action' => 'index'], ['class' => 'nav-link']) ?></li>
<li><?= $this->Html->link(__('New Devsim'), ['controller' => 'Devsims', 'action' => 'add'], ['class' => 'nav-link']) ?></li>
<li><?= $this->Html->link(__('List Freedevs'), ['controller' => 'Freedevs', 'action' => 'index'], ['class' => 'nav-link']) ?></li>
<li><?= $this->Html->link(__('New Freedev'), ['controller' => 'Freedevs', 'action' => 'add'], ['class' => 'nav-link']) ?></li>
<?php $this->end(); ?>
    ...
    <tbody>
        ...
        <tr>
           ...
           <div class="btn-group" role="group" >
                ...
                <?= $this->Html->link('', ['action' => 'view', $devmodel->id], ['title' => __('View'), 'class' => 'btn btn-outline-dark btn-sm bi-info-lg mr-1']) ?>

                <?= $this->Html->link('', ['action' => 'edit', $devmodel->id], ['title' => __('Edit'), 'class' => 'btn btn-outline-dark btn-sm bi-pencil mr-1']) ?>

                <?= $this->Form->postLink('', ['action' => 'delete', $devmodel->id], ['confirm' => __('Are you sure you want to delete # {0}?', $devmodel->id), 'title' => __('Delete'), 'class' => 'btn btn-sm btn-danger bi-trash mr-1']) ?>
