  ...
  function Add() {
       ...
       <!--  e inserisce il dato di ritorno nel  -->
        ...
        jQuery.ajax({
            ...
            $('#devmodel_id').append(newOption).trigger('change');               
 ...
 * @var \App\Model\Entity\Devsim[]|\Cake\Collection\CollectionInterface $devsims
 * @var \App\Model\Entity\Freedev[]|\Cake\Collection\CollectionInterface $freedevs
 */
?>
<?php $this->layout = 'ajax'; ?>


<div class="modal-dialog" role="document" id="modaldevmodels">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Aggiungi Devmodel </h5>
...
<div class="devmodels form content card-body">

     <?= $this->Form->create($devmodel,['id'=>'adddevmodels','url' => false]);   
...
$(document).ready(function () {
        ...
        $('#devmodelsAddClick').on('click', Add);
                });
</script>    
</div>
