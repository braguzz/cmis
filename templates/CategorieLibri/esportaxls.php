...
use Cake\View\Helper\TimeHelper;
 ...
 foreach ($categorieLibri as $categorieLibro) : 
        $riga =$this->Number->format($categorieLibro->id);
$foglioExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(1, $riganum, $riga); 
 $categorieLibro->has('libro') ? $riga= $categorieLibro->libro->id : $riga.='';
$foglioExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow(2, $riganum, $riga); 
 $categorieLibro->has('categoria') ? $riga= $categorieLibro->categoria->title : $riga.='';
...
endforeach; 
   ...
   $col=4;      
	...
	header('Content-Disposition: attachment;filename="Export_categorieLibro.xlsx"');      //nome del file    
