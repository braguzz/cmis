  ...
  function Add() {
       ...
       <!--  e inserisce il dato di ritorno nel  -->
        ...
        jQuery.ajax({
            ...
            $('#prova_id').append(newOption).trigger('change');               
...
<div class="modal-dialog" role="document" id="modalprove">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Aggiungi Prova </h5>
...
<div class="prove form content card-body">
     ...
     <?= $this->Form->create($prova,['id'=>'addprove','url' => false]);   
