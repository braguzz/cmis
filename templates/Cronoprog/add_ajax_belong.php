  ...
  function Add() {
       ...
       <!--  e inserisce il dato di ritorno nel  -->
        ...
        jQuery.ajax({
            ...
            $('#cronoprogramma_id').append(newOption).trigger('change');               
...
<div class="modal-dialog" role="document" id="modalcronoprog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Aggiungi Cronoprogramma </h5>
...
<div class="cronoprog form content card-body">

     <?= $this->Form->create($cronoprogramma,['id'=>'addcronoprog','url' => false]);   
      $this->Form->setConfig('autoSetCustomValidity', false);
      ?>
    <fieldset>
        <?php
            echo $this->Form->control('DESATTIV');
            echo $this->Form->control('PESOATTIV');
            echo $this->Form->control('FSP');
            echo $this->Form->control('FSI');
            echo $this->Form->control('FSL');
            echo $this->Form->control('RESTATTIV');
            echo $this->Form->control('DATAINIPREV');
            echo $this->Form->control('DATAFINEPREV');
            echo $this->Form->control('DATAINIEFF');
            echo $this->Form->control('DATAFINEFF');
            echo $this->Form->control('STATOATTUAZ');
            echo $this->Form->control('PERCATTUAZ');
        ?>
    </fieldset>
 <?= $this->Form->submit('ok',array(
    'id'=>'cronoprogAddClick',
...
$(document).ready(function () {
        ...
        $('#cronoprogAddClick').on('click', Add);
                });
</script>    
</div>
