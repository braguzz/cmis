...
<h1 class="page-header">Aggiungi Cronoprogramma</h1>
 </div>  
 </div>
</div>
...
<div class="cronoprog form content card-body">
    <?= $this->Form->create($cronoprogramma) ?>
    ...
    <fieldset>
        <?php
          ...
          echo $this->Form->control('VERSIONE', array('type' => 'text'));
            echo $this->Form->control('IDINT', array('type' => 'text'));
              echo $this->Form->control('CODATTIV', array('type' => 'text'));
