 ...
 * @var \App\Model\Entity\Lingua $lingua
 */
?>
...
<div class="lingue view large-9 medium-8 columns content">
    
 <!-- ========= PB: TITOLO CON RELATIVI BOTTONI ====================== -->
<div class="titolo_pulsanti">
<div class="row align-items-center mb-2">  
<div class="col col-sm-auto">
    <h1 class="page-header">Lingua: <?= h($lingua->title) ?></h1>
 </div>  
 <div class="col-10 col-sm-auto">
     <div class="btn-group" role="group">
<?= $this->Html->link('', ['action' => 'edit', $lingua->id], ['title' => __('Edit'), 'class' => 'btn btn-outline-dark bi-pencil mr-1']) ?>
 <?= $this->Html->link('', ['action' => 'add', $lingua->id], ['title' => __('Add'), 'class' => 'btn btn-outline-info bi-plus-lg mr-1']) ?>
<?= $this->Form->postLink('', ['action' => 'delete', $lingua->id], ['confirm' => __('Sei sicuro di rimuovere # {0}?', $lingua->id), 'title' => __('Delete'), 'class' => 'btn btn-danger bi-trash mr-1']) ?>
...
<div role='tabpanel' class="tab-pane <?= $activetab ?>" id='Dischi' >
 ...
 <div class="col btn-group" role="group"> 
    <?= $this->Form->postButton('', ['controller' => 'Dischi', 'action' => 'add'],['data'=>['returncontroller'=>'lingue','returnsaveme' => '0','returnaction'=>'view','returncontrollerid'=>$lingua->id], 'class' => 'btn btn-sm btn-info bi-plus m-1']) ?>
     
       </div>
      <div class="col">
        <?php if (!empty($lingua->dischi)): ?>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-sm" id="DischiTable">
                ...
                <?php foreach ($lingua->dischi as $dischi): ?>
                ...
                <?= $this->Form->postButton('', ['controller' => 'Dischi', 'action' => 'edit', $dischi->id],['data'=>['returncontroller'=>'lingue','returnsaveme' => '0','returnaction'=>'view','returncontrollerid'=>$lingua->id], 'class' => 'btn btn-outline-dark btn-sm bi-pencil mr-1 rounded-0']) ?>
...
<div role='tabpanel' class="tab-pane <?= $activetab ?>" id='Libri' >
   <div class="related">
 <div class="col btn-group" role="group"> 
    <?= $this->Form->postButton('', ['controller' => 'Libri', 'action' => 'add'],['data'=>['returncontroller'=>'lingue','returnsaveme' => '0','returnaction'=>'view','returncontrollerid'=>$lingua->id], 'class' => 'btn btn-sm btn-info bi-plus m-1']) ?>
     
       </div>
      <div class="col">
        <?php if (!empty($lingua->libri)): ?>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-sm" id="LibriTable">
                ...
                <?php foreach ($lingua->libri as $libri): ?>
                ...
                <?= $this->Form->postButton('', ['controller' => 'Libri', 'action' => 'edit', $libri->id],['data'=>['returncontroller'=>'lingue','returnsaveme' => '0','returnaction'=>'view','returncontrollerid'=>$lingua->id], 'class' => 'btn btn-outline-dark btn-sm bi-pencil mr-1 rounded-0']) ?>
