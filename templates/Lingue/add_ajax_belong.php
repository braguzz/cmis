  ...
  function Add() {
       ...
       <!--  e inserisce il dato di ritorno nel  -->
        ...
        jQuery.ajax({
            ...
            $('#lingua_id').append(newOption).trigger('change');               
...
<div class="modal-dialog" role="document" id="modallingue">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Aggiungi Lingua </h5>
...
<div class="lingue form content card-body">

     <?= $this->Form->create($lingua,['id'=>'addlingue','url' => false]);   
