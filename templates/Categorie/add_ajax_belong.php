...
<div class="modal-dialog" role="document" id="modalcategorie">
...
<div class="categorie form content card-body">
     ...
     <?= $this->Form->create($categoria,['id'=>'addcategorie','url' => false]);   
      $this->Form->setConfig('autoSetCustomValidity', false);
      ?>
    <fieldset>
        <?php
            echo $this->Form->control('title');
            echo $this->Form->control('libri._ids', ['options' => $libri]);
                ?>
    </fieldset>
 <?= $this->Form->submit('ok',array(
    'id'=>'categorieAddClick',
...
$(document).ready(function () {
        ...
        $('#categorieAddClick').on('click', Add);
                });
</script>    
</div>
