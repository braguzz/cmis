...
<h1 class="page-header">Aggiungi Disco</h1>
 </div>  
 </div>
</div>
        ...
        <?php
          ...
          //  echo $this->Form->control('lingua_id', ['options' => $lingue, 'empty' => true]);
                    ...
                    echo '<div class="form-group required">'; 
                        ...
                        echo  $this->Form->select('lingua_id', $lingue, ['id' => 'lingua_id']);
...
<script>
     $(document).ready(function () {
        $('#linguaButtonAdd').click({nome: 'Lingue', returncontroller: 'dischi'}, Aggiungi);            doAcSelect2('lingua_id', 'Lingue' , 'title', 3);  
        });
</script>
...
<script>
     $(document).ready(function () {
        $('#autoreButtonAdd').click({nome: 'Autori', returncontroller: 'dischi'}, Aggiungi);            doAcSelect2('autore_id', 'Autori' , 'id', 3);  
        });
</script>
