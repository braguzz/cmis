...
use Cake\View\Helper\TimeHelper;
 ...
 foreach ($libri as $libro) : 
        $riga =$this->Number->format($libro->id);
...
endforeach; 
   ...
   $col=8;      
	...
	header('Content-Disposition: attachment;filename="Export_libro.xlsx"');      //nome del file    
