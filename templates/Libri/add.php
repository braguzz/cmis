...
<h1 class="page-header">Aggiungi Libro</h1>
 </div>  
 </div>
</div>
...
<script>
     $(document).ready(function () {
        $('#linguaButtonAdd').click({nome: 'Lingue', returncontroller: 'libri'}, Aggiungi);            
        doAcSelect2('lingua_id', 'Lingue' , 'title', 0);  
        });
</script>
...
<script>
     $(document).ready(function () {
        $('#autoreButtonAdd').click({nome: 'Autori', returncontroller: 'libri'}, Aggiungi);            
        doAcSelect2('autore_id', 'Autori' , 'cognome', 0);  
        });
</script>
...
<!-- lo script Seleziona'nometabella' serve per selezionare quello giusto al click di 'seleziona' nella finestra modale di ricerca' -->
<script>
     $(document).ready(function () {            doAcSelect2('categorie-ids', 'Categorie' , 'title', 0);                 
