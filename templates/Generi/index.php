...
<h1 class="page-header"><?= 'Generi' ?></h1>
 </div>  
...
<li><?= $this->Html->link(__('New Genere'), ['action' => 'add'], ['class' => 'nav-link']) ?></li>
    ...
    <tbody>
        ...
        <tr>
           ...
           <div class="btn-group" role="group" >
                ...
                <?= $this->Html->link('', ['action' => 'view', $genere->id], ['title' => __('View'), 'class' => 'btn btn-outline-dark btn-sm bi-info-lg mr-1']) ?>

                <?= $this->Html->link('', ['action' => 'edit', $genere->id], ['title' => __('Edit'), 'class' => 'btn btn-outline-dark btn-sm bi-pencil mr-1']) ?>

                <?= $this->Form->postLink('', ['action' => 'delete', $genere->id], ['confirm' => __('Are you sure you want to delete # {0}?', $genere->id), 'title' => __('Delete'), 'class' => 'btn btn-sm btn-danger bi-trash mr-1']) ?>
