...
<table class="table table-striped table-sm">
    ...
    <?= $this->Form->postButton('', ['controller' => $return['returncontroller'], 'action' => 'addhabtm', $return['returncontrollerid']],['data'=>['id'=>$genere->id, 'returnid'=>$return['returncontrollerid'], 'return'=>'Generi'], 'class' => 'btn btn-outline-dark btn-sm bi-check  mr-1','title'=>'Inserisci collegamento']) ?>
