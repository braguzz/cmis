  ...
  function Add() {
       ...
       <!--  e inserisce il dato di ritorno nel  -->
        ...
        jQuery.ajax({
            ...
            $('#genere_id').append(newOption).trigger('change');               
...
<div class="modal-dialog" role="document" id="modalgeneri">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Aggiungi Genere </h5>
...
<div class="generi form content card-body">

     <?= $this->Form->create($genere,['id'=>'addgeneri','url' => false]);   
