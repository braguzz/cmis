...
class Tx_AtolCmisList_ViewHelpers_Default_ThumbnailViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
   /**
   * @var tslib_cObj
   */
  ...
  **/
  public function render($obj){
    ...
    if($rendition=$obj->getRenditions('cmis:thumbnail')){
