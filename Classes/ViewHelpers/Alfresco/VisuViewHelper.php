...
* Displays image or flash rendition
*/
class Tx_AtolCmisList_ViewHelpers_Alfresco_VisuViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
  /**
   * @var tslib_cObj
   */
  ...
  **/
  public function render($obj){
    ...
    //Pas de flash, on test pour image
