...
class Tx_AtolCmisList_ViewHelpers_Alfresco_RenditionViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
  ...
  public function render($obj,$rk){
      ...
      if($rendition=$obj->getRenditions($rk)){
          ...
          if($type[0]=='image')
            ...
            $output = '<embed id="webpreview" src="'.$src.'" type="application/x-shockwave-flash" height="500" width="500"/>' ;       
      }    
      return $output;
