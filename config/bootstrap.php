...
try {
    ...
    //PB
     Configure::load('regtosc', 'default');
...
//Regole di trasformazione dei nomi delle tabelle, da singolare a plurale (OPZIONALE)
//ESEMPIO da personalizzare

Inflector::rules('irregular', ['autore' => 'autori']);
Inflector::rules('irregular', ['libro' => 'libri']);
Inflector::rules('irregular', ['lingua' => 'lingue']);
Inflector::rules('irregular', ['categoria' => 'categorie']);
